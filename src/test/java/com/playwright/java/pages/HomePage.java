...
public class HomePage extends WebClient {
  ...
  public HomePage clickOption(String option) {
    _driverManager.getPage().waitForNavigation(() -> {
      _driverManager.getPage().click(String.format(ElementReference.Almatar.PRODUCT_OPTION, option));
    });
    return this;
  }

  public HomePage EnterGoingTo(String goingTo) {
    _driverManager.getPage().type(ElementReference.Almatar.GOING_TO,goingTo);
    return this;
  }

  public HomePage SelectPredictiveResult() {
      _driverManager.getPage().click(ElementReference.Almatar.SEARCH_RESULT);
    return this;
  }

  public HomePage SelectCheckInDate() {
    _driverManager.getPage().click(ElementReference.Almatar.CHECK_IN_BOX);
    _driverManager.getPage().click(ElementReference.Almatar.CHECK_IN_DATE);
    return this;
  }

  public HomePage SelectCheckoutDate() {
    //_driverManager.getPage().click(ElementReference.Almatar.CHECK_OUT_BOX);
    _driverManager.getPage().click(ElementReference.Almatar.CHECK_OUT_DATE);
    return this;
  }

  public HomePage SelectTravellers() {
    _driverManager.getPage().click(ElementReference.Almatar.TRAVELLERS_OPTION);
    _driverManager.getPage().click(ElementReference.Almatar.CHILDREN_ICON_PLUS);
    return  this;
  }

  public HomePage ClickOnSearchOption() {
    _driverManager.getPage().click(ElementReference.Almatar.SEARCH_ICON);
    return this;
  }

  public HomePage SelectLanguage(String lang) {
    _driverManager.getPage().click(String.format(ElementReference.Almatar.LANGUAGE_OPTION, lang));
    return this;
  }
}
